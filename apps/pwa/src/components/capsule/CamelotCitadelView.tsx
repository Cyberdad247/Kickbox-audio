...
export function CamelotCitadelView({ onEnterWorkspace }: CamelotCitadelViewProps) {
      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        ...
        >
          ...
          <div className="relative flex h-64 w-64 items-center justify-center">
            ...
            <div className={`transition-all duration-1000 delay-500 text-6xl ${step >= 2 ? 'opacity-100' : 'opacity-0'}`}>
              🏰
            </div>
          </div>
        </div>
        ...
        <button
          ...
          className={`mt-12 group flex items-center gap-3 rounded-full border border-gold-royal/30 bg-gold-royal/10 px-8 py-4 font-mono text-sm font-bold uppercase tracking-widest text-gold-royal shadow-neon-gold transition-all hover:bg-gold-royal/20 hover:scale-105 cursor-pointer ${
