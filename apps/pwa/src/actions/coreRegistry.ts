...
export const KNIGHTS_REGISTRY: KnightMetrics[] = [
  ...
  },
  {
    id: 'CODEX_011',
    name: 'Sir Codex',
    role: 'SaaS Reforge Implementer',
    framework: 'Spec-Guided',
    drive: 'wire the real surface and verify it.',
    tier: 'S4_Strategic',
    tunnel: 'local_http_proxy_cms_0x011',
    responsibilities: [
      'cms template rendering',
      'draft to publish workflow hardening',
      'local relay dispatch verification',
    ],
    escalation: 'Ambassador Lakisha',
  },
  {
    id: 'AVATAR_012',
    name: 'Lady Lakesha Runtime',
    role: 'Avatar Runtime Auditor',
    framework: 'Runtime Profiling',
    drive: 'frame the avatar correctly on the first render.',
    tier: 'S3_Contextual',
    tunnel: 'lakisha_runtime_profile_0x012',
    responsibilities: [
      'device-class video tuning',
      'screen-fit validation',
      'poster fallback continuity',
    ],
    escalation: 'Sir Codex',
  },
  {
    id: 'PROP_004',
